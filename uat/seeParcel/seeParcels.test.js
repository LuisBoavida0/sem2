...
/** Scenario: 
 *   See the customer parcels */
 tom.test('See the customer parcels     ', async function () {
        ...
        // THEN I should see the parcels
                ...
                await assert.equal(heading, true, 'It is not showing parcels on the homepage, please verify if this account has any parcels')
                await browser.close()
})
module.exports = tom